...
annotations_folder = 'D:/Github/data/COVID-19-20/COVID-19-20_v2/2d_segment_data'
# print(annotations_folder)

image_folder = os.path.join("D:/Github/data/COVID-19-20/COVID-19-20_v2/2d_segment_data/images")
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        ...
        return tfds.core.DatasetInfo(
            ...
            features=tfds.features.FeaturesDict({
                'images': tfds.features.Tensor(shape=(None, None), dtype=tf.float16, encoding='bytes'),
                'label': tfds.features.Tensor(shape=(None, None), dtype=tf.float16, encoding='bytes'),
            }),
    ...
    def _generate_examples(self, images_dir_path, annotations_dir_path, images_list_file):
        with tf.io.gfile.GFile(images_list_file, "r") as images_list:
            for line in images_list:
                ...
                images_data = images_data.astype(float16)

                label_path = os.path.join(bitmaps_dir_path, image_name)
